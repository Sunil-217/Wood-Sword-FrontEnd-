    ...
    return (
      <Container className="py-20">
        <div className="mx-auto max-w-md text-center">
          <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-brand-50 text-ball-400">
  ...
  return (
    <Container className="py-8 sm:py-10">
      <div className="flex items-end justify-between">
        ...
        <button
          onClick={clear}
          className="text-sm font-medium text-brand-900/50 transition-colors hover:text-ball-500"
        >
          Clear all
        </button>
      </div>
